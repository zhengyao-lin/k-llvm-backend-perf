...
public class Tak36 {
  ...
  public static void main (String[] args) {
    System.out.println (`tak (Pos (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (d0()))))))))))))))))))))))))))))))))))))), Pos (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (s (d0()))))))))))))))))))), Pos (s (s (s (s (s (s (s (s (s (s (s (s (d0())))))))))))))));
  }
}
