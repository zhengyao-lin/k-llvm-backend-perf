// TOM-A
import missionaries2.term.*;
import missionaries2.term.types.*;
public class Missionaries2 {
  %gom{
    module Term
    abstract syntax
    Bank =
  ...
  public static void main (String[] args) {
    System.out.println (`solve (pos (west(), d2(), d2(), d0(), d0()), pos (east(), d0(), d0(), d2(), d2()), nil_pl()));
  }
}
