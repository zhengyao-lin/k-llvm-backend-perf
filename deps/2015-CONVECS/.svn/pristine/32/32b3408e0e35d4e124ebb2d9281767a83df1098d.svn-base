...
select Fibonacci05 .
exec fibb (s (s (s (s (s (d0)))))) .
exec fibb (fibb (s (s (s (s (s (d0))))))) .
exec fibb (fibb (fibb (s (s (s (s (s (d0)))))))) .
exec fibb (fibb (fibb (fibb (s (s (s (s (s (d0))))))))) .
exec fibb (fibb (fibb (fibb (fibb (s (s (s (s (s (d0)))))))))) .
