...
then
	wget https://cmake.org/files/v3.5/cmake-3.5.2-Linux-i386.tar.gz
	tar zxf cmake-3.5.2-Linux-i386.tar.gz
	export PATH="$LIB/cmake-3.5.2-Linux-i386/bin:$PATH"
fi
...
then
	...
	tar qt-everywhere-opensource-src-5.6.0.tar.gz
